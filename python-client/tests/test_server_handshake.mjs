...
var ProxyTracerProvider =
  ...
  (function () {
    ...
    ProxyTracerProvider2.prototype.getTracer = function (
      ...
      var _a;
      return (_a = this.getDelegateTracer(name, version2, options)) !== null &&
        _a !== void 0
        ? _a
        : new ProxyTracer(this, name, version2, options);
    };
    ...
    ProxyTracerProvider2.prototype.getDelegateTracer = function (
      ...
      return (_a = this._delegate) === null || _a === void 0
        ? void 0
        : _a.getTracer(name, version2, options);
    };
...
var OpaqueTransportMessageSchema = TransportMessageSchema(Type.Unknown());
...
// router/errors.ts
import { Kind, Type as Type2 } from '@sinclair/typebox';
...
function getSerializedProcErrors(procDef) {
  if (
    ...
    procDef.responseError[Kind2] === 'Never'
  ) {
...
var SessionStateGraph = {
  ...
  transition: {
    ...
    WaitingForHandshakeToConnected: (
      pendingSession,
      oldSession,
      sessionId,
      to,
...
var ServerTransport = class extends Transport {
  ...
  async onHandshakeRequest(session, msg) {
    ...
    if (this.handshakeExtensions) {
      if (
        !Value3.Check(this.handshakeExtensions.schema, msg.payload.metadata)
      ) {
        this.rejectHandshakeRequest(
          session,
          msg.from,
